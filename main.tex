...
\usepackage{amsmath,amsfonts,amssymb,epsfig,enumerate,calc,color,ifthen} % original was times, but I think it's ugly; we use the same as IEEE CompSoc
...
\title{Flocking of Unmanned Aerial Vehicles under Visual Relative Positioning}    % Title of the thesis.
...
\subject{the Department of Electronic and Computer Engineering}                              % Subject of the Degree.
\department{Electronic and Computer Engineering}                           % Department to which the thesis is submitted.
\advisor{Prof. Li Qiu}          % Supervisor.
\member{Prof. Bertram Emil Shi, Department Head}     % committee member
\defencedate{2019}{08}{21}      % \defencedate{year}{month}{day}.

...
\begin{figure}[H]
  ...
  \caption{$\psi_{scal}$ with various models. Model 1 from~\cite{Vicsek1995}, model 2 from~\cite{CuckerSmale2007} and model 3 from~\cite{CuckerDong2010}.}\label{fig:N_scal}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Average relative distance from various models. Model 1 from~\cite{Vicsek1995}, model 2 from~\cite{CuckerSmale2007} and model 3 from~\cite{CuckerDong2010}.}\label{fig:N_dis}
\end{figure}

\section{Comparison with Tracking Algorithm}
...
\begin{figure}[H]
  ...
  \subfigure[Relative distance between target and chaser UAVs. The desired shifted distance $d_s=1.5$ while the averaged relative distance $\bar{v}=1.39$.]{\label{fig:distance_plot}\includegraphics[width=0.49\textwidth]{figure/chapter_5/distance_plot.png}}
  \quad
  ...
  \caption{\textcolor{red}{TODO: Modify $\psi_{scal}$ plot.}}\label{fig:position_distance}
\end{figure}

...
We first show the results when the leader UAV moves purely in the directions of x-axis (positive pointing forward) and y-axis (positive pointing left) as illustrated in Fig.\ref{fig:x_indoor} and Fig.\ref{fig:y_indoor}.

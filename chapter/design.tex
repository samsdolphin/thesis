...
$\mathbf{Proposition 1}$: For all $t>0$, $-Hk\|\mathbf{v}\|+\langle L_f\mathbf{x}, \mathbf{v}\rangle\leq\frac{d}{dt}\|\mathbf{v}\|\leq-\frac{Hk\|\mathbf{v}\|}{(1+2\|\mathbf{x}\|^2)^{\beta}}+\langle L_f\mathbf{x}, \mathbf{v}\rangle$.

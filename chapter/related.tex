...
\begin{figure}[htb]
  ...
  \subfigure[$a_{ij}(x)$ with $\sigma=1$, $K=1$ and $\beta=0.48$ in~\cite{CuckerSmale2007}]{\label{fig:cs_aij}\includegraphics[width=0.48\textwidth]{figure/chapter_2/cs_aij.png}}

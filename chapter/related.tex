...
\begin{figure}[htb]
  \centering
  \subfigure[$a_{ij}(x)$ with $R=1$ in~\cite{Vicsek1995}]{\label{fig:v_aij}\includegraphics[width=0.48\textwidth]{figure/vicsek_aij.eps}}
  \subfigure[$a_{ij}(x)$ with $\sigma=1$, $K=1$ and $\beta=0.48$ in~\cite{CuckerSmale2007}]{\label{fig:cs_aij}\includegraphics[width=0.48\textwidth]{figure/cs_aij.eps}}
  \caption{Examples of $a_{ij}(s)$ in~\cite{Vicsek1995},~\cite{CuckerSmale2007}}\label{fig:example_v}
\end{figure}

\textcolor{red}{TODO: Attach experiment reference.}
